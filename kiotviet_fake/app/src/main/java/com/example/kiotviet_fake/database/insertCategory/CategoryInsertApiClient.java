...
public class CategoryInsertApiClient {
    private static final String BASE_URL = "http://gaycoffee-001-site1.jtempurl.com/";

    public static CategoryInsertService createService(String username, String password) {
        ...
        return retrofit.create(CategoryInsertService.class);
    }
}
