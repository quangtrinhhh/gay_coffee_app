...
public class ProductDeleteApiClient {
    private static final String BASE_URL = "http://gaycoffee-001-site1.jtempurl.com/";

    public static ProductDeleteService createService(String username, String password) {
        ...
        return retrofit.create(ProductDeleteService.class);
    }
}
