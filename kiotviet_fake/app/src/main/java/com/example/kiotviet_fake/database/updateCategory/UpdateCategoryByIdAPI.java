...
public class UpdateCategoryByIdAPI {
    private static final String BASE_URL = "http://gaycoffee-001-site1.jtempurl.com/";

    public static UpdateCategoryByIdService createService(String username, String password) {
        ...
        return retrofit.create(UpdateCategoryByIdService.class);
    }
}
